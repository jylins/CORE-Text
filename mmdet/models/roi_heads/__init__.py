...
from .bbox_heads import (BBoxHead, ConvFCBBoxHead, DIIHead,
                         ...
                         VRM2FCBBoxHead, CORE2FCBBoxHead)
...
from .mask_heads import (CoarseMaskHead, FCNMaskHead, FeatureRelayHead,
                         ...
                         SCNetMaskHead, SCNetSemanticHead, FCNMaskPolyHead)
...
from .core_poly_roi_head import COREPolyRoIHead
...
__all__ = [
    ...
    'PolyRoIHead', 'FCNMaskPolyHead',
    'VRMPolyRoIHead', 'VRM2FCBBoxHead',
    'COREPolyRoIHead', 'CORE2FCBBoxHead'
]
